...
<head>
    ...
    <body>
        ...
        <div class="page-container">
            <div class="register">
                <div class="login-bg" style="background-color: #2d95ec;background-image: url(hh.jpg);"></div>
                <div class="login-content">
                    <div class="login-box">
                        <div class="login-header">
                            <h3 style="color:#2d95ec ">Create New Account</h3>
                        ...
                        <div class="login-body">
                            <form action="register_handle.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" required="" name="f_name" id="exampleFirstName" placeholder="Firstname ">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" required="" name="l_name" id="exampleLastName" placeholder="Lastname">
                                </div>
                                <div class="custom-control custom-checkbox form-group">
                                    <input type="checkbox" class="custom-control-input" id="exampleCheck1">
                                    <label class="custom-control-label" for="exampleCheck1">
                                        I agree to <a href="#"  data-toggle="modal" data-target="#exampleModalCenter" style="color:#2d95ec ">Terms &amp; Conditions</a>
                                    </label>
                                </div>
                                <button type="submit" name="register" class="btn btn-primary" style="background-color: #2d95ec !important;border-color:#2d95ec !important">Register</button>
                            </form>
