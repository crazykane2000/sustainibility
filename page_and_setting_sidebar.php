            ...
            <div class="page-sidebar" style="background:-webkit-linear-gradient(top,#2196F3 0,#ff5722 100%);">
                ...
                <div class="page-sidebar-inner">
                    <div class="page-sidebar-menu">
                        <ul>
                            <li>
                                <a href="dashboard.php" data-toggle="tooltip" data-placement="right" title="Dashboard"><i class="fas fa-rocket"></i></a>
                            </li>
                            <li>
                                <a href="notifications.php" data-toggle="tooltip" data-placement="right" title="Notifications"><i class="fas fa-globe-africa"></i></a>
                            </li>
            ...
            <div class="settings-sidebar">
                <div class="settings-sidebar-content">
                    ...
                    <div class="right-sidebar-settings">
                        ...
                        <a href="" style="padding: 10px;padding-left:30px;display: block">Update Profile Here</a>
